...
const PinterestShareButton = (props) => {
    ...
    return (
        ...
        <a href={url} role="button" className="shareicons-icon-wrapper shareicons-share-btn shareicons-svc-pinterest_share"><span className="at4-visually-hidden">Share to Pinterest</span><span className="shareicons-icon-wrapper"><title id="shareicons-svg-pinterest_share-9">Pinterest</title></span></a>
    )
}
...
const FacebookShareButton = (props) => {
    ...
    return (
        <a href={url} role="button" className="shareicons-icon-wrapper shareicons-share-btn shareicons-svc-facebook"><span className="at4-visually-hidden">Share to Facebook</span><span className="shareicons-icon-wrapper"><title id="shareicons-svg-facebook-7">Facebook</title></span></a>
    )
}
...
const TwitterShareButton = (props) => {
    ...
    return (
        <a href={url} role="button" className="shareicons-icon-wrapper shareicons-share-btn shareicons-svc-twitter"><span className="at4-visually-hidden">Share to Twitter</span><span className="shareicons-icon-wrapper"><title id="shareicons-svg-twitter-8">Twitter</title></span></a>
    )
}
...
registerBlockType('growth-hacker-custom-blocks/xfeature-block', {
    ...
    edit: (props) => {
        const {
            attributes: { title, mediaID, mediaURL, content, ctaURL, ctaLabel, ctaMuteLabel, borderClassName, shareIcons },
            setAttributes,
            className,
        } = props;
        ...
        const onChangeShareIcons = (value) => {
            setAttributes({shareIcons:value});
        }
            ...
            <div className={`xfeature-block ${className} ${borderClassName}`}>
                ...
                <div className="block-borders-settings">
                    ...
                    <CheckboxControl
                        ...
                        checked={shareIcons}
                        onChange={value => { onChangeShareIcons(value) }}
                    />
                    Borders:
                    <CheckboxControl
                        label="Top"
            ...
            <div className={`xfeature-block ${className} ${borderClassName}`}>
                ...
                <div className="article-block__content">
                    ...
                    <div className="article-block__box">
                        ...
                        >{ shareIcons && <div className="controls-box share-open"><div className="controls-box__button controls-box__button-favorite icon-bookmark"></div><div className="controls-box__share"><div className="controls-box__button controls-box__button-share icon-share"></div><div className="controls-box__share-drop">
